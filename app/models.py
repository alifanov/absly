...
class GAFunnelConfig(models.Model):
    ...
    activation_value = models.IntegerField(default=0, verbose_name=u'Кол-во пользователей [Activation]', blank=True)
    retention_value = models.IntegerField(default=0, verbose_name=u'Кол-во пользователей [Retention]', blank=True)
    referral_value = models.IntegerField(default=0, verbose_name=u'Кол-во пользователей [Referral]', blank=True)
    revenue_value = models.IntegerField(default=0, verbose_name=u'Кол-во пользователей [Revenue]', blank=True)
